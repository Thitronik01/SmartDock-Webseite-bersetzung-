          ...
          <div className="flex items-center justify-between h-20">
            ...
            >
              <img 
                ...
                alt={currentLanguage === 'ES' ? 'Logotipo de SMARTDOCK' : 'SMARTDOCK Logo'}
            ...
            <div className="hidden xl:flex items-center space-x-4 z-10 ml-auto">
              ...
              <button 
                ...
                aria-label={currentLanguage === 'ES' ? 'Mostrar u ocultar la navegación secundaria' : 'Toggle secondary navigation'}
              >
