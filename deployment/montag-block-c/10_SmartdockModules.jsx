...
const SmartdockModules = () => {
  ...
  const modules = [
    { 
      ...
      altEs: 'Hélice submarina con luz de neón verde'
    },
    { 
      id: 'tcu', 
      ...
      altEs: 'Embarcación blanca vista desde arriba sobre agua verde con estela de espuma'
    },
    { 
      id: 'tcup', 
      ...
      altEs: 'Embarcación blanca vista desde el aire sobre agua turquesa con control de trimado',
      customTitle: 'TCU-P'
    },
    { 
      id: 'acu', 
      ...
      altEs: 'Embarcación con símbolo de ancla verde y luz de neón'
    },
    { 
      id: 'wcu', 
      ...
      altEs: 'Cabo verde sobre un herraje de la embarcación'
    }
  ];
            ...
            >
              ...
              <div className="w-full mt-auto shrink-0">
                {mod.image ? (
                  <img 
                    src={mod.image} 
                    alt={currentLanguage === 'ES' ? mod.altEs : mod.alt}
