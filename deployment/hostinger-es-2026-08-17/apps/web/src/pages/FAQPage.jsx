...
import { translateSourceText } from '@/utils/translations/index.js';
...
const DEALER_LINK_CONFIG = {
  ...
  ES: { regex: /distribuidores/i, label: 'Distribuidores' },
};
...
const PAGE_TEXTS = {
  ...
  ES: {
    ...
    subtitle: 'Encuentra respuestas a las preguntas más importantes sobre SMARTDOCK, su instalación y su uso.',
    error: 'No se han podido cargar las preguntas frecuentes. Comprueba tu conexión a internet e inténtalo de nuevo.',
    tryAgain: 'Intentar de nuevo',
    noFaqs: 'En este momento no se ha encontrado ninguna pregunta frecuente.',
    home: 'Inicio',
    desc: 'Preguntas frecuentes sobre SMARTDOCK: compatibilidad, instalación, funciones y mucho más.',
    langCode: 'es-ES'
  }
};
            ...
            <Accordion type="single" collapsible className="space-y-4">
              {faqs.map((faq) => {
                ...
                if (currentLanguage === 'EN') {
                  ...
                  question = translateSourceText(faq.question_de, 'ES');
                  answer = translateSourceText(faq.answer_de, 'ES');
                }

                // Fallback if translations are empty
                question = question || (currentLanguage === 'ES' ? '[ES missing]' : faq.question_de);
                answer = answer || (currentLanguage === 'ES' ? '[ES missing]' : faq.answer_de);
