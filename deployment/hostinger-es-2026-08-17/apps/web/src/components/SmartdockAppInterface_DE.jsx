    ...
    <section className="pt-0 pb-24 md:pb-32 relative overflow-hidden bg-background">
      <div className="container px-4 sm:px-6 lg:px-8 mx-auto max-w-7xl">
        ...
        >
          <img 
            src={imageUrl} 
            alt={currentLanguage === 'ES' ? 'iPhone 15 Pro con la interfaz de la app SMARTDOCK' : isEn ? "iPhone 15 Pro with SMARTDOCK App Interface" : isFr ? "iPhone 15 Pro avec l'interface de l'application SMARTDOCK" : "iPhone 15 Pro mit SMARTDOCK App Oberfläche"}
