...
import PrivacyPage_ES from '@/pages/PrivacyPage_ES.jsx';
import ImpressumPage from '@/pages/ImpressumPage.jsx';
import ImpressumPage_EN from '@/pages/ImpressumPage_EN.jsx';
import ImpressumPage_ES from '@/pages/ImpressumPage_ES.jsx';
    ...
    <div className="min-h-[100dvh] flex flex-col bg-background text-foreground w-full font-sans antialiased overflow-x-hidden relative">
      ...
      <main className="flex-grow flex flex-col w-full relative">
        <Routes>
          ...
          {/* ---------- Spanish preview routes (/es, intentionally hidden from the switcher) ---------- */}
          <Route path="/es" element={<HomePage />} />
          <Route path="/es/producto" element={<ProduktPage />} />
          <Route path="/es/funciones" element={<FunktionenPage />} />
          <Route path="/es/funciones-legado" element={<FunktionenPage />} />
          <Route path="/es/instalacion" element={<InstallationPage />} />
          <Route path="/es/faq" element={<FAQPage />} />
          <Route path="/es/contacto" element={<HomePage />} />
          <Route path="/es/configurador" element={<ConfiguratorPage />} />
          <Route path="/es/distribuidores" element={<DealerFinderPage />} />
          <Route path="/es/privacidad" element={<PrivacyPage_ES />} />
          <Route path="/es/aviso-legal" element={<ImpressumPage_ES />} />
          <Route path="/es/terminos" element={<AGBPage />} />
          <Route path="/es/accesibilidad" element={<AccessibilityPage />} />
          <Route path="/es/desistimiento" element={<WiderrufsbelehrungPage />} />
          <Route path="/es/envios" element={<VersandbedingungPage />} />
