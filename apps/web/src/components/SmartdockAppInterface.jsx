...
const SmartdockAppInterface = ({ image }) => {
  const { currentLanguage } = useLanguage();
  const isEn = currentLanguage === 'EN';

  // Fallback to the original German-labeled image if none is provided
  const imageUrl = image || "https://horizons-cdn.hostinger.com/9e931b78-a97e-475e-99a2-3a70b48cf364/function_app_en-ewtdd.png";
      ...
      <div className="container px-4 sm:px-6 lg:px-8 mx-auto max-w-7xl">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto mb-16 text-balance">
            {isEn 
              ? 'The SMARTDOCK app turns your smartphone into a mobile helm for your boat. You control important maneuvers exactly where you have the best overview—at the bow, stern, or midships. With intuitive swipe gestures and customizable control modes, you always have full control of your ship.' 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12 text-left pt-8 border-t border-border/50">
            ...
            <div>
              ...
              <p className="text-base text-muted-foreground leading-relaxed">
                {isEn 
                  ? 'Activate High-Mode for instant, maximum thrust when maneuvering conditions require quick action.' 
...
export default SmartdockAppInterface;
